    ...
    for a in city:
        ...
        for b in bDict:
            ...
            for cityInfo in cityList:
                cityName = cityInfo['display']
                code = cityInfo['data'].split("|")[-1]
                citys[cityName] = code
    print(citys)
